    ...
    <form method="POST" action="" class="needs-validation mb-3" enctype="multipart/form-data" novalidate>
      ...
      <div class="input-group mb-3 width">
        ...
        <input type="text" name="title" class="form-control "
          value="<?php echo $title; ?>" id="validationCustom01"
      ...
      <div>
        ...
        <figure class="figure">
          <img
            src="<?php echo SITE_URL; ?>images/category/<?php echo $current_image; ?>"
            class="figure-img img-fluid rounded" width="300px" height="300px"
            alt="<?php echo $title; ?>">
      ...
      <div class="form-group">
        ...
        <div class="form-check form-check-inline">
          ...
          type="radio" id="inlineCheckbox1" value="Yes" name="featured"
...
if (isset($_POST['submit'])) {
  ...
  // update database
  $sql_update = "UPDATE `category` SET title='$title', image_name=$image_name, featured='$featured', active='$active' WHERE id=$id ";
